            ...
            <div className="w-full p-6 space-y-6">
              ...
              <div className="grid grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-2xl font-bold text-[#2e2d52]">{selectedItem.distance}km</p>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <p className="text-2xl font-bold text-[#2e2d52]">{difficultyLabels[selectedItem.difficulty]}</p>
                </div>
              </div>
