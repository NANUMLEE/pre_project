  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="px-6 py-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm mb-6">
          <div className="flex items-center gap-2 mb-4">
            <History className="w-5 h-5 text-[#03cfb4]" />
            <h3 className="text-[#2e2d52]">내 기록</h3>
          </div>
        ...
        {/* General Settings */}
        <div className="bg-white rounded-2xl p-6 shadow-sm mb-6">
          <h3 className="text-[#2e2d52] mb-4">일반 설정</h3>
          
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Bell className="w-5 h-5 text-[#787878]" />
                <span className="text-sm text-[#2e2d52]">알림</span>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Settings className="w-5 h-5 text-[#787878]" />
                <span className="text-sm text-[#2e2d52]">음성 안내</span>
              </div>
              <Switch defaultChecked />
            </div>
          </div>
